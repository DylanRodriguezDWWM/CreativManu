...
try {
    ...
    WHERE categorie.nom_categorie = 'Naissance'
...
<head>
    ...
    <title>Page de produits de naissance</title>
    <meta name="description" content="Explorez notre sélection de nouveaux articles de naissance. Chaque produit est présenté avec une image, le nom, la quantité en stock et le prix. Trouvez le cadeau de naissance parfait aujourd'hui.">
    <link rel="stylesheet" href="./css/articles.css">
</head>
<body>
    <main>
    
    <h2 id="textarticle">Nouveaux articles pour naissance</h2>
