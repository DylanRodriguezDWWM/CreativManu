...
try {
    ...
    WHERE categorie.nom_categorie = 'Mariage'
...
<head>
    ...
    <title>Page de produits de mariage</title>
    <meta name="description" content="Explorez notre sélection de nouveaux articles de mariage. Chaque produit est présenté avec une image, le nom, la quantité en stock et le prix. Trouvez le cadeau de mariage parfait aujourd'hui.">
    <link rel="stylesheet" href="./css/articles.css">
</head>
<body>
    <main>
    
    <h2 id="textarticle">Nouveaux articles pour mariage</h2>
